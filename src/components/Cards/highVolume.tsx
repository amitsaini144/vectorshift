            ...
            <div className='rounded-2xl p-10 bg-gradient-to-b from-[#100923] via-[#10052b] to-[#130436] border border-[#430B8A] text-white w-80 h-full'>
                <div className='flex flex-col justify-between h-full'>
                    <div className='flex flex-col gap-6'>
                        <h2 className='text-3xl md:text-4xl md:font-semibold'>High volume chatbot</h2>
                        <p className='text-sm md:text-lg leading-8 tracking-wider md:tracking-normal'>We leverage our secure infrastructure and development.</p>
                    </div>
